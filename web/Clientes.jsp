                    ...
                    <div class="card-body">
                        <form action="Catalogo?menu=Cliente" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" value="${cliente.getId()}" name="txtId" class="form-control" placeholder="Ingrese ID" required>
                            </div>
                            <div class="mb-3">
                                            ...
                                            <table class="table" style="width: 100%" id="clientesTable">
                                                ...
                                                <c:forEach var="cliente" items="${listaClientes}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="button" type="button" href="Catalogo?menu=Cliente&accion=Delete&id=${cliente.getId()}"><span class="button__text">Delete</span>
