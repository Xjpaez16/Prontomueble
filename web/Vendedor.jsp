                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                       ...
                                       <form action="Catalogo?menu=Vendedor" method="POST">
                                       <div class="samibtn">
                                       <input type="hidden" name="accion" value="consultaVendedor">
                                        <button type="submit" class="botoncon">Reporte Vendedor Mas Ventas</button>
                                       </div>
                                        </form>
                                       ...
                                       <table class="table" >
                                           ...
                                           <tbody>
                                               <tr>
                                                   <td class="text-center">${vendedorId}</td>
