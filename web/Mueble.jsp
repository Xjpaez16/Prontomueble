                    ...
                    <div class="card-body">
                        <form action="Catalogo?menu=Mueble" method="POST">
                            ...
                            <div class="d-flex justify-content-between ">
                                ...
                                <form action="Catalogo?menu=Mueble" method="POST">
                                    <div class="samibtn">
                                        <input type="hidden" name="accion" value="consultaMueble">
                                        <button type="submit" class="botoncon">Muebles mas vendidos</button>
                                    </div>
                                </form>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <table class="table" >
                                                ...
                                                <tbody>
                                                    <c:forEach var="muebles" items="${listaCl}">
                                                        <tr>
                                                            <td class="text-center">${muebles[0]}</td>
                                                            <td>${muebles[1]}</td>
                                                            <td>${muebles[2]}</td>
                                                    </tr>
                                                </c:forEach>
